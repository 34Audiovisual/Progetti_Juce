...
void feedCoontrols (float ln1_coeff, float inG_in2, float drv_in3, float bld_in4, float outG_in5)
{
    setLn1(ln1_coeff);
...
void setLn1 (float ln) { ln1Coeff = ln; }
...
private:
    ...
    float ingain{0.f}, outgain{0.f}, drive{0.f}, blend{0.f}, ln1Coeff{1.f};
